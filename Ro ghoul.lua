local gui = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/z4gs/scripts/master/testtttt.lua"))():AddWindow("GenzoRoghoul", {
    main_color = Color3.fromRGB(255,223,0),
...
local tab1, tab2, tab3, tab4 = gui:AddTab("Autofarm"), gui:AddTab("Farm Settings"), gui:AddTab("AutoTrainer"), gui:AddTab("Misc")
...
labels = setmetatable({
    ...
    Exp = {prefix = "Exp: ", label = 
tab1:AddLabel("Exp: 0"),value = 0}
